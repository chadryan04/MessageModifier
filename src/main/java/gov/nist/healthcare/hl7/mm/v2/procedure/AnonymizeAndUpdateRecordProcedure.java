...
public class AnonymizeAndUpdateRecordProcedure extends Procedure {
	...
	@Override
	public void execute(TransformRequest transformRequest, Map<String, String> parameterMap) throws  IOException {
